...
function FocusStartModal({ isOpen, onClose }: FocusStartModalProps) {
  ...
  const handleStart = () => {
    ...
    useFocusStore
      .getState()
      .startFocus(selectedCard?.id ?? null, selectedCard?.title ?? null, selectedProjectId || null);
    onClose();
      ...
      <FocusTrap active={isOpen} onDeactivate={onClose}>
        ...
        >
          ...
          <div className="px-5 py-4 space-y-5">
            ...
            {/* Project selector */}
            <div>
              <label className="text-xs text-surface-500 uppercase tracking-wider mb-2 block">Project (optional)</label>
              <HudSelect
              ...
              <div>
                ...
                {selectedCard ? (
                  <div className="flex items-center gap-2 px-3 py-2 bg-surface-50 dark:bg-surface-800 rounded-lg border border-surface-200 dark:border-surface-700">
                    <span className="text-sm text-surface-800 dark:text-surface-200 truncate flex-1">
                      {selectedCard.title}
                    </span>
                    <button
            ...
            {/* Duration presets */}
            <div>
              <label className="text-xs text-surface-500 uppercase tracking-wider mb-2 block">Duration</label>
              <div className="flex items-center gap-2">
            ...
            {/* Start button */}
            <button onClick={handleStart} className="w-full py-2.5 btn-primary clip-corner-cut-sm text-sm font-medium">
