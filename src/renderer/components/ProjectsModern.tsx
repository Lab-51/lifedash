          ...
          <div className="mb-8 hud-panel-accent clip-corner-cut-sm p-6 shadow-lg animate-in fade-in slide-in-from-top-4 duration-300">
            ...
            <form onSubmit={handleCreate}>
              <div className="space-y-4">
                ...
                <div>
                  <label className="block text-xs font-medium text-surface-500 uppercase tracking-wider mb-1.5">
                    Hourly Rate <span className="normal-case font-normal">(optional — for billable time tracking)</span>
                  </label>
          ...
          <div className="mt-20 flex flex-col items-center justify-center text-center">
            ...
            <p className="text-surface-500 max-w-xs mx-auto mb-8">
              {searchQuery
                ...
                : 'Create your first project to start organizing tasks and ideas.'}
            </p>
            {!searchQuery && (
              <button
                onClick={() => setShowCreateForm(true)}
