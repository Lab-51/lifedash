...
export default function SettingsPageClassic() {
        ...
        <div className="p-6 max-w-4xl mx-auto">
            ...
            <section className="mb-10">
                ...
                <div className="space-y-6">
                    <div>
                        <h3 className="text-sm font-medium text-surface-300 mb-2">Theme Mode</h3>
                        <ThemeSelector />
                    </div>

                    <div>
                        <h3 className="text-sm font-medium text-surface-300 mb-2">Design Style</h3>
                        <DesignSelector />
                    </div>
                </div>
            </section>
