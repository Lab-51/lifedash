                    ...
                    <div className="relative" ref={autoMenuRef}>
                      ...
                      {showAutoMenu && enabledProviders.length > 1 && (
                        <div className="absolute top-full right-0 mt-1 min-w-[160px] hud-panel clip-corner-cut-sm p-1 z-10">
                          <p className="text-[0.625rem] text-[var(--color-text-muted)] px-2 py-1 uppercase tracking-wider">
                            Select provider
                          </p>
                          {enabledProviders
                            ...
                            .map((p) => (
                              <button
                                key={p.id}
                                onClick={() => {
                                  taskModelRef.current?.autoAssign(p);
                                  setShowAutoMenu(false);
                                }}
              ...
              <section className="hud-panel-accent clip-corner-cut p-8 text-center">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-2xl mx-auto">
                  <div className="p-4 hud-panel clip-corner-cut-sm">
                    ...
                    <p className="font-[var(--font-display)] text-[var(--color-text-primary)] font-medium">
                  ...
                  <div className="p-4 hud-panel clip-corner-cut-sm">
                    ...
                    <p
                      className={`font-[var(--font-display)] font-medium ${encryptionAvailable ? 'text-emerald-500' : 'text-[var(--color-text-secondary)]'}`}
                    >
                  ...
                  <div className="p-4 hud-panel clip-corner-cut-sm">
                    ...
                    <p className="font-[var(--font-display)] text-[var(--color-text-primary)] font-medium capitalize">
                    ...
                    {updateStatus === 'downloading' && (
                      <div className="flex flex-col items-center gap-2">
                        <div className="flex items-center gap-2 text-sm text-[var(--color-text-secondary)]">
                          ...
                          <span>
                            Downloading {updateRelease}... {updateProgress > 0 ? `${updateProgress}%` : ''}
                          </span>
                        </div>
                        {updateProgress > 0 && (
