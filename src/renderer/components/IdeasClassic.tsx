// === FILE PURPOSE ===
// Ideas page — Classic Design
// Displays the idea repository with quick-add form, status filter tabs, search, and idea cards.
...
export default function IdeasClassic() {
