  ...
  return (
    <>
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-[var(--color-text-secondary)] mt-0.5">
                Collaborate with AI to refine your ideas.
              </p>
            </div>
                    ...
                    <div className="space-y-2 max-h-48 overflow-y-auto pr-1 scrollbar-thin scrollbar-thumb-surface-300 dark:scrollbar-thumb-surface-700">
                      {BRAINSTORM_TEMPLATES.map((template) => (
                        ...
                        >
                          ...
                          <div>
                            <p
                              className={`text-sm font-semibold ${selectedTemplateId === template.id ? 'text-[var(--color-accent)]' : 'text-[var(--color-text-primary)]'}`}
                            >
                              {template.name}
                            </p>
            ...
            {!activeSession && !loadingSession ? (
              <div className="flex-1 flex items-center justify-center">
                <EmptyFeatureState
                  ...
                  benefits={[
                    'Brainstorm freely in natural language',
                    'AI knows about your projects',
                    'Save insights as cards or ideas',
                  ]}
              ...
              <>
                  ...
                  <div className="max-w-3xl mx-auto space-y-6">
                    {activeSession.messages.map((msg) => (
                      <ChatMessageModern
                        ...
                        onExportToCard={
                          msg.role === 'assistant' && activeSession?.projectId ? handleExportToCard : undefined
                        }
                      />
                    ))}
                      ...
                      <div className="flex justify-start mb-6 group animate-in fade-in duration-300">
                        <div className="max-w-[90%] w-full">
                          <div className="flex items-center gap-2 mb-1 px-1">
                            ...
                            <span className="text-[0.625rem] font-medium text-surface-500 uppercase tracking-wider">
                              AI Assistant
                            </span>
                ...
                <div className="p-4 bg-surface-50 dark:bg-[var(--color-chrome)] border-t border-[var(--color-border)]">
                  <div className="max-w-3xl mx-auto relative">
                    ...
                    <div
                      className={`relative bg-surface-50 dark:bg-[var(--color-chrome)] border-2 rounded-2xl focus-within:bg-white dark:focus-within:bg-surface-900 transition-all shadow-sm ${voice.isListening ? 'border-red-400 dark:border-red-500' : 'border-[var(--color-border)] focus-within:border-[var(--color-accent)]'}`}
                    >
                      <textarea
                        ref={textareaRef}
                        value={input}
                        ...
                        placeholder={
                          voice.isListening ? 'Listening...' : voice.isProcessing ? 'Transcribing...' : 'Message AI...'
                        }
                        rows={1}
      ...
      <ConfirmDialog
        ...
        variant="danger"
        onConfirm={() => {
          if (confirmDeleteId) handleDeleteSession(confirmDeleteId);
        }}
