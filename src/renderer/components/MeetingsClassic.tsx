// === FILE PURPOSE ===
// Meetings page — Classic Design
// Displays the meeting list with recording controls, status filter tabs, and meeting cards.
...
export default function MeetingsClassic() {
                ...
                <div className="flex items-center gap-1">
                    {FILTER_TABS.map(tab => (
                        <button
                            ...
                            className={`px-3 py-1.5 rounded-lg text-sm transition-colors ${filter === tab.value
