...
export default function BackgroundAgentSettings() {
  ...
  const usagePct =
    dailyUsage && preferences ? Math.min(100, (dailyUsage.tokensUsed / preferences.dailyTokenBudget) * 100) : 0;
            ...
            <div className="relative shrink-0">
              ...
              <div
                ...
                className={`w-10 h-6 rounded-full cursor-pointer transition-colors ${
                  preferences.enabled ? 'bg-[var(--color-accent)]' : 'bg-[var(--color-border)]'
                }`}
              >
                <div
            ...
            <div className="space-y-5 pl-0">
              ...
              <div className="flex items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-xs text-[var(--color-text-muted)] mt-0.5">
                    How often the agent scans your projects
                  </p>
                </div>
                  ...
                  <label className="flex items-center gap-3 cursor-pointer">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-[var(--color-text-muted)]">
                        Flag cards with no activity past a threshold
                      </p>
                    </div>
                  </label>
                </div>
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="font-data text-xs text-[var(--color-text-muted)]">
                    {dailyUsage ? formatTokens(dailyUsage.tokensUsed) : '0'} /{' '}
                    {formatTokens(preferences.dailyTokenBudget)} tokens
                  </span>
                </div>
