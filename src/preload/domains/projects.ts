...
export const projectsBridge = {
  ...
  reorderProjects: (items: { id: string; sortOrder: number }[]) => ipcRenderer.invoke('projects:reorder', items),
  ...
  updateBoard: (id: string, data: UpdateBoardInput) => ipcRenderer.invoke('boards:update', id, data),
  ...
  updateColumn: (id: string, data: UpdateColumnInput) => ipcRenderer.invoke('columns:update', id, data),
  deleteColumn: (id: string) => ipcRenderer.invoke('columns:delete', id),
  reorderColumns: (boardId: string, columnIds: string[]) => ipcRenderer.invoke('columns:reorder', boardId, columnIds),
  ...
  updateCard: (id: string, data: UpdateCardInput) => ipcRenderer.invoke('cards:update', id, data),
  ...
  updateLabel: (id: string, data: UpdateLabelInput) => ipcRenderer.invoke('labels:update', id, data),
  deleteLabel: (id: string) => ipcRenderer.invoke('labels:delete', id),
  attachLabel: (cardId: string, labelId: string) => ipcRenderer.invoke('labels:attach', cardId, labelId),
  detachLabel: (cardId: string, labelId: string) => ipcRenderer.invoke('labels:detach', cardId, labelId),
};
