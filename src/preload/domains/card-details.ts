...
export const cardDetailsBridge = {
  ...
  addCardComment: (input: CreateCardCommentInput) => ipcRenderer.invoke('card:addComment', input),
  updateCardComment: (id: string, content: string) => ipcRenderer.invoke('card:updateComment', id, content),
  deleteCardComment: (id: string) => ipcRenderer.invoke('card:deleteComment', id),

  // Relationships
  getCardRelationships: (cardId: string) => ipcRenderer.invoke('card:getRelationships', cardId),
  getRelationshipsByBoard: (boardId: string) => ipcRenderer.invoke('cards:getRelationshipsByBoard', boardId),
  addCardRelationship: (input: CreateCardRelationshipInput) => ipcRenderer.invoke('card:addRelationship', input),
  deleteCardRelationship: (id: string) => ipcRenderer.invoke('card:deleteRelationship', id),
  ...
  // Checklist Items
  getChecklistItems: (cardId: string) => ipcRenderer.invoke('card:getChecklistItems', cardId),
  addChecklistItem: (cardId: string, title: string) => ipcRenderer.invoke('card:addChecklistItem', { cardId, title }),
  ...
  deleteChecklistItem: (id: string) => ipcRenderer.invoke('card:deleteChecklistItem', id),
  ...
  generateCardDescription: (cardId: string) => ipcRenderer.invoke('card:generate-description', cardId),
