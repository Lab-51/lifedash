...
export const LEVEL_TIERS: LevelTier[] = [
  // --- Metal family (tiers 1-5, Lv 1-50) ---
  {
    ...
    endLevel: 10,
    animate: false,
    colors: { bg: 'bg-amber-900/20', text: 'text-amber-600', border: 'border-amber-700/30', glow: '' },
  },
  {
    tier: 2,
    name: 'Iron',
    ...
    endLevel: 20,
    animate: false,
    colors: { bg: 'bg-slate-600/20', text: 'text-slate-400', border: 'border-slate-500/30', glow: '' },
  },
  {
    tier: 3,
    name: 'Steel',
    ...
    endLevel: 30,
    animate: false,
    colors: { bg: 'bg-zinc-500/20', text: 'text-zinc-300', border: 'border-zinc-400/30', glow: '' },
  },
  {
    tier: 4,
    name: 'Silver',
    ...
    endLevel: 40,
    animate: false,
    colors: { bg: 'bg-gray-400/15', text: 'text-gray-300', border: 'border-gray-400/30', glow: '' },
  },
  {
    tier: 5,
    name: 'Gold',
    ...
    colors: {
      ...
      glow: '0 0 6px rgba(234, 179, 8, 0.15)',
    },
  },
  ...
  // --- Gem family (tiers 6-10, Lv 51-100) ---
  {
    ...
    colors: {
      ...
      glow: '0 0 8px rgba(52, 211, 153, 0.2)',
    },
  },
  {
    tier: 7,
  ...
  // --- Cosmic family (tiers 11-15, Lv 101-150) ---
  {
    ...
    colors: {
      ...
      gradient: 'linear-gradient(135deg, #312e81, #5b21b6)',
    },
  },
  {
    tier: 12,
  ...
  },
  {
    ...
    colors: {
      ...
      glow: '0 0 12px rgba(103, 232, 249, 0.25)',
      gradient: 'linear-gradient(135deg, #164e63, #1e40af)',
    },
  },
  {
    tier: 14,
    ...
    colors: {
      ...
      glow: '0 0 12px rgba(94, 234, 212, 0.25)',
      gradient: 'linear-gradient(135deg, #134e4a, #065f46)',
    },
  },
  {
    tier: 15,
  ...
  // --- Mythic family (tiers 16-20, Lv 151-200) ---
  {
    ...
    colors: {
      ...
      gradient: 'linear-gradient(135deg, #9a3412, #dc2626)',
    },
  },
  {
    tier: 17,
    ...
    colors: {
      ...
      text: 'text-red-300',
      border: 'border-red-500/30',
      glow: '0 0 16px rgba(248, 113, 113, 0.3)',
      gradient: 'linear-gradient(135deg, #991b1b, #e11d48)',
    },
  },
  {
    tier: 18,
    ...
    colors: {
      ...
      glow: '0 0 16px rgba(214, 211, 209, 0.3)',
      gradient: 'linear-gradient(135deg, #44403c, #b45309)',
    },
  },
  {
    tier: 19,
    ...
    colors: {
      ...
      glow: '0 0 16px rgba(196, 181, 253, 0.3)',
      gradient: 'linear-gradient(135deg, #5b21b6, #a21caf)',
    },
  },
  {
    tier: 20,
    ...
    colors: {
      ...
      text: 'text-sky-200',
      border: 'border-sky-400/30',
      glow: '0 0 16px rgba(125, 211, 252, 0.3)',
      gradient: 'linear-gradient(135deg, #0369a1, #3730a3)',
    },
  },
  ...
  // --- Divine family (tiers 21-25, Lv 201-250) ---
  {
    ...
    colors: {
      ...
      glow: '0 0 20px rgba(147, 197, 253, 0.35)',
      gradient: 'linear-gradient(135deg, #334155, #1e40af)',
    },
  },
  {
    tier: 22,
  ...
  },
  {
    ...
    colors: {
      ...
      glow: '0 0 20px rgba(216, 180, 254, 0.35)',
      gradient: 'linear-gradient(135deg, #581c87, #6d28d9)',
    },
  },
  {
    tier: 24,
    ...
    colors: {
      ...
      glow: '0 0 20px rgba(253, 230, 138, 0.35)',
  ...
  },
  {
    ...
    colors: {
      ...
      glow: '0 0 20px rgba(254, 249, 195, 0.35)',
      gradient: 'linear-gradient(135deg, #fefce8, #ca8a04)',
    },
  },
  ...
  // --- Ultimate family (tiers 26-30, Lv 251-300) ---
  {
    ...
    colors: {
      ...
      glow: '0 0 24px rgba(251, 113, 133, 0.4)',
  ...
  },
  {
    ...
    colors: {
      ...
      glow: '0 0 24px rgba(165, 180, 252, 0.4)',
  ...
  },
  {
    ...
    colors: {
      ...
      text: 'text-amber-100',
      border: 'border-amber-400/30',
      glow: '0 0 24px rgba(252, 211, 77, 0.4)',
  ...
  },
  {
    ...
    colors: {
      ...
      glow: '0 0 24px rgba(103, 232, 249, 0.4)',
  ...
  },
  {
    ...
    colors: {
      ...
      gradient: 'linear-gradient(135deg, #eab308, #fefce8, #eab308)',
    },
  },
];
...
export const ACHIEVEMENTS = [
  ...
  },
  {
    id: 'one_hour_day',
    name: 'Power Hour',
    description: '60+ minutes focused in a single day',
    icon: 'Clock',
    category: 'focus',
  },
  {
    id: 'two_hour_day',
    name: 'Deep Worker',
    description: '120+ minutes focused in a single day',
    icon: 'BrainCircuit',
    category: 'focus',
  },
  {
    ...
    description: '180+ minutes focused in a single day',
    icon: 'Hourglass',
    category: 'focus',
  },
  {
    id: 'four_hour_day',
    name: 'Touch Grass Soon',
    description: '240+ minutes focused in a single day',
    icon: 'TreePine',
    category: 'focus',
  },
  {
    ...
    description: '3 consecutive days with sessions',
    icon: 'TrendingUp',
    category: 'focus',
  },
  {
  ...
  },
  {
    ...
    description: '14 consecutive days with sessions',
    icon: 'CalendarCheck',
    category: 'focus',
  },
  {
    id: 'streak_30',
    name: 'Monthly Master',
    description: '30 consecutive days with sessions',
    icon: 'Award',
    category: 'focus',
  },
  {
    id: 'streak_60',
    name: 'Two-Month Terror',
    description: '60 consecutive days with focus sessions',
    icon: 'Flag',
    category: 'focus',
  },
  {
    id: 'streak_100',
    name: 'Century Streak',
    description: '100 consecutive days with focus sessions',
    icon: 'Infinity',
    category: 'focus',
  },
  {
    id: 'focus_500_min',
    name: '500 Club',
    description: 'Accumulate 500 total focus minutes',
    icon: 'History',
    category: 'focus',
  },
  {
    id: 'focus_2000_min',
    name: 'Time Lord',
    description: 'Accumulate 2,000 total focus minutes',
    icon: 'Globe',
    category: 'focus',
  },
  {
    id: 'focus_10000_min',
    name: '10K Grinder',
    description: 'Accumulate 10,000 total focus minutes',
    icon: 'Mountain',
    category: 'focus',
  },
  {
    id: 'level_50',
    name: 'Gold Achiever',
    description: 'Reach Level 50 (Gold tier)',
    icon: 'Trophy',
    category: 'focus',
  },
  {
    id: 'level_100',
    name: 'Diamond Hands',
    description: 'Reach Level 100 (Diamond tier)',
    icon: 'Gem',
    category: 'focus',
  },
  {
    ...
    description: 'Reach Level 200 (Celestial tier)',
    icon: 'Star',
    category: 'focus',
  },
  ...
  {
    id: 'cards_completed_50',
    name: 'Fifty and Fired Up',
    description: 'Complete 50 cards',
    icon: 'Gift',
    category: 'cards',
  },
  {
    id: 'cards_completed_100',
  ...
  {
    id: 'checklist_100',
    name: 'Checkbox Addict',
    description: 'Complete 100 checklist items',
    icon: 'CircleCheck',
    category: 'cards',
  },
  {
    id: 'checklist_500',
    name: 'List Maniac',
    description: 'Complete 500 checklist items',
    icon: 'ScrollText',
    category: 'cards',
  },
  {
    id: 'ai_descriptions_5',
    name: 'AI Ghostwriter',
    description: 'Generate 5 AI card descriptions',
    icon: 'PenTool',
    category: 'cards',
  },
  {
    ...
    description: 'Use AI task breakdown 3 times',
    icon: 'GitBranch',
    category: 'cards',
  },
  ...
  },
  {
    id: 'projects_10',
    name: 'Serial Starter',
    description: 'Create 10 projects (finishing is overrated)',
    icon: 'Map',
    category: 'projects',
  },
  {
    id: 'project_planner',
    name: 'AI Architect',
    description: 'Use AI planning on a project',
    icon: 'Bot',
    category: 'projects',
  },
  {
    id: 'project_archiver',
    name: 'Spring Cleaner',
    description: 'Archive your first project',
    icon: 'Archive',
    category: 'projects',
  },
  {
    id: 'ai_plans_5',
    name: 'AI Strategist',
    description: 'Use AI planning 5 times',
    icon: 'Wand2',
    category: 'projects',
  },
  {
    ...
    description: 'Generate 5 AI standup reports',
    icon: 'Coffee',
    category: 'projects',
  },
  ...
  // Meetings (10)
  {
    ...
    description: 'Complete your first meeting recording',
    icon: 'Mic',
    category: 'meetings',
  },
  {
    ...
    description: 'Complete 5 meeting recordings',
    icon: 'Headphones',
    category: 'meetings',
  },
  {
    id: 'meeting_maven',
    name: 'Meeting Maven',
    description: 'Complete 10 meeting recordings',
    icon: 'Video',
    category: 'meetings',
  },
  {
    ...
    description: 'Survive 25 meeting recordings',
    icon: 'Umbrella',
    category: 'meetings',
  },
  {
    id: 'meetings_50',
    name: 'Professional Listener',
    description: 'Complete 50 meetings — send help',
    icon: 'Ear',
    category: 'meetings',
  },
  {
    ...
    description: 'Generate 5 meeting briefs',
    icon: 'FileText',
    category: 'meetings',
  },
  {
    id: 'briefs_20',
    name: 'TL;DR Expert',
    description: 'Generate 20 meeting briefs',
    icon: 'BookOpen',
    category: 'meetings',
  },
  {
    id: 'action_hero',
    name: 'Action Hero',
    description: 'Convert 10 action items to cards',
  ...
  },
  {
    id: 'actions_25',
    name: 'Action Jackson',
    description: 'Convert 25 action items to cards',
    icon: 'Crosshair',
    category: 'meetings',
  },
  {
    id: 'actions_50',
    name: 'Action Avalanche',
    description: 'Convert 50 action items to cards',
    icon: 'Tornado',
    category: 'meetings',
  },
  ...
  { id: 'ideas_25', name: 'Idea Factory', description: 'Create 25 ideas', icon: 'Sun', category: 'ideas' },
  {
    id: 'ideas_50',
    name: 'Idea Fountain',
    description: 'Create 50 ideas (slow down, Edison)',
    icon: 'Waves',
    category: 'ideas',
  },
  {
    id: 'idea_converter',
    name: 'Idea Alchemist',
    description: 'Convert 5 ideas to projects or cards',
    icon: 'Sparkles',
    category: 'ideas',
  },
  {
    id: 'ideas_converted_10',
    name: 'Idea Evangelist',
    description: 'Convert 10 ideas to projects or cards',
    icon: 'Send',
    category: 'ideas',
  },
  {
    id: 'ideas_analyzed_5',
    name: 'Feasibility Guru',
    description: 'Analyze 5 ideas with AI',
    icon: 'Search',
    category: 'ideas',
  },
  {
    id: 'ideas_analyzed_20',
    name: 'Over-Analyzer',
    description: 'Analyze 20 ideas with AI',
    icon: 'Eye',
    category: 'ideas',
  },
  ...
  // Brainstorm (8)
  {
    id: 'first_brainstorm',
    name: 'Brainstarter',
    description: 'Start your first brainstorm session',
    icon: 'Brain',
    category: 'brainstorm',
  },
  {
    id: 'brainstorms_5',
    name: 'Storm Chaser',
    description: 'Complete 5 brainstorm sessions',
    icon: 'Wind',
    category: 'brainstorm',
  },
  {
    id: 'deep_thinker',
    name: 'Deep Thinker',
    description: 'Complete 10 brainstorm sessions',
    icon: 'BrainCog',
    category: 'brainstorm',
  },
  {
    ...
    description: 'Complete 25 brainstorm sessions',
    icon: 'Hexagon',
    category: 'brainstorm',
  },
  {
    ...
    description: 'Complete 50 brainstorm sessions',
    icon: 'Anchor',
    category: 'brainstorm',
  },
  {
    id: 'brainstorm_exports_1',
    name: 'Idea Smuggler',
    description: 'Save a brainstorm message as card',
    icon: 'Share',
    category: 'brainstorm',
  },
  {
    id: 'brainstorm_exports_10',
    name: 'Share the Wisdom',
    description: 'Export 10 brainstorm messages as cards',
    icon: 'MessageCircle',
    category: 'brainstorm',
  },
  {
    id: 'brainstorm_exports_25',
    name: 'Brainstorm Librarian',
    description: 'Export 25 brainstorm messages as cards',
    icon: 'GraduationCap',
    category: 'brainstorm',
  },
  ...
  // Cross-feature (12)
  {
    id: 'multitasker',
    name: 'Multitasker',
    description: 'Earn XP in 3+ categories in one day',
    icon: 'LayoutGrid',
    category: 'cross',
  },
  {
    ...
    description: 'Earn XP in 5+ categories in one day',
    icon: 'Wrench',
    category: 'cross',
  },
  ...
  },
  {
    id: 'all_categories',
    name: 'Category Sweep',
    description: 'Earn XP in all 6 categories in one day',
    icon: 'Users',
    category: 'cross',
  },
] as const;
